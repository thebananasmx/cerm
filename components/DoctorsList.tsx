              ...
              <div className="p-8 sm:p-10">
                ...
                <div className="space-y-3">
                  <a 
                    ...
                    className="flex items-center justify-center gap-3 w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-4 rounded-2xl transition-all shadow-lg active:scale-95"
                  >
